...
This repository contains the replication package evaluating the causal impact of state-initiated minimum wage increases ($\ge 5 percent\%$) on employment in the **Food Services and Drinking Places industry (NAICS 722)**. 
